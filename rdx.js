...
const listen = require('./RDX/commands/cache/system/listen');
const { loadCommands, loadEvents } = require('./RDX/commands/cache/system/handle/handleRefresh');
const UsersController = require('./RDX/commands/cache/system/controllers/users');
const ThreadsController = require('./RDX/commands/cache/system/controllers/threads');
const CurrenciesController = require('./RDX/commands/cache/system/controllers/currencies');

const configPath = path.join(__dirname, 'config.json');
const appstatePath = path.join(__dirname, 'appstate.json');
const islamicPath = path.join(__dirname, 'RDX/commands/cache/data/islamic_messages.json');
...
async function sendQuranAyat() {
  ...
  try {
    const threads = require('./RDX/commands/cache/system/database/models/threads').getAll();
    const approvedThreads = threads.filter(t => t.receive_messages === 1 && t.banned !== 1);
